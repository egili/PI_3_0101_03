...
final Map<String, DialogueNode> gameScript = {
  ...
  'h15_intro_1': DialogueNode(
    ...
    nextNodeId: 'h15_intro_1b',
  ),

  'h15_intro_1b': DialogueNode(
    id: 'h15_intro_1b',
  ...
  'h15_intro_8': DialogueNode(
    ...
    characterName: 'Dr. Garibaldo',
    text:
        'E… tem os rumores… que eu não gosto de considerar, mas também não posso ignorar… o que é cientificamente frustrante. Dizem que ele não está sozinho. Que ele faz parte de uma organização… uma sociedade secreta… os chamados Illuminati dos mares.',
    nextNodeId: 'h15_intro_8b',
  ),

  'h15_intro_8b': DialogueNode(
    id: 'h15_intro_8b',
    characterName: 'Dr. Garibaldo',
    text: 'Ninguém sabe ao certo quem ou o que eles são. Mas uma coisa eu garanto…',
    nextNodeId: 'h15_intro_8c',
  ),

  'h15_intro_8c': DialogueNode(
    id: 'h15_intro_8c',
    characterName: 'Dr. Garibaldo',
    text: 'ELE É… CRUEL. METODICAMENTE CRUEL. E PODEROSO de um jeito que eu não consigo quantificar ainda… o que é… preocupante.',
    nextNodeId: 'h15_intro_8d',
  ),

  'h15_intro_8d': DialogueNode(
    id: 'h15_intro_8d',
    characterName: 'Dr. Garibaldo',
  ...
  'h15_intro_10a': DialogueNode(
    id: 'h15_intro_10a',
    characterName: 'Dr. Garibaldo',
    text: 'Excelente, {nome}! Finalmente alguém racional! Leve-o de volta à Biblioteca.',
  ...
  'hosp_truffles_2a': DialogueNode(
    ...
    characterName: 'Truffles',
    text:
        'Ajudar? Hm… improvável. Mas já que insistiu, {nome}… talvez seja necessário.',
  ...
  'hosp_recalibra_4': DialogueNode(
    id: 'hosp_recalibra_4',
    characterName: 'Truffles',
    text: 'Funcionou. Isso… realmente funcionou. (pausa) {nome}, você não é tão inútil quanto parece.',
  ...
  'mercadao_beta_8': DialogueNode(
    ...
    characterName: 'Beta',
    text:
        'Variável não prevista detectada. (pausa) {nome}. Você interferiu na coleta. Interferiu na distribuição. Interferiu no equilíbrio do sistema. (pausa) Agora… você será testado.',
  ...
  'h15_final_7': DialogueNode(
    ...
    characterName: 'Dr. Garibaldo',
    text:
        'E você, {nome}… Você foi a variável que eu não consegui calcular.',
